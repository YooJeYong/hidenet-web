...
export default function RegisterPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!alias.trim()) {
            setError("ERROR: ALIAS REQUIRED");
            return;
        }

        if (alias.length < 3) {
            setError("ERROR: ALIAS TOO SHORT (MIN 3)");
            return;
        }
            ...
            <div className="w-full max-w-md border border-[var(--border-bright)] bg-[var(--bg-panel)]">
                ...
                <div className="p-5 md:p-8">
                    ...
                    <div className="mb-6 text-[0.75rem] leading-[1.8] text-[var(--text-dim)]">
                        ...
                        <p>
                            <span className="text-[var(--green)]">$</span> SET
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <label
                                ...
                                className="text-[0.6875rem] text-[var(--text-dim)] shrink-0 w-8 md:w-28 text-left"
                            >
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                placeholder="v0id_walk3r"
                                maxLength={20}
                                autoComplete="off"
                                className="flex-1 bg-transparent border-b border-[var(--border-bright)] text-[var(--cyan)] font-[inherit] text-[0.75rem] md:text-[0.8125rem] outline-none py-1 caret-[var(--green)] placeholder:text-[var(--text-dim)]"
                            />
                        </div>
                    ...
                    <div className="mt-6 pt-4 border-t border-[var(--border)] text-[0.6875rem] text-[var(--text-dim)]">
                        ...
                        <Link
                            href="/login"
                            className="text-[var(--cyan)] no-underline hover:[text-shadow:0_0_8px_var(--cyan)]"
                        >
                            [AUTHENTICATE]
                        </Link>
                    </div>
